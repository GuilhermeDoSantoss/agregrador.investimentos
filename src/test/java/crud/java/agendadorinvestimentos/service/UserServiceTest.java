...
class UserServiceTest {
    ...
    class createUser {
        ...
        void shouldCreateAUserWithSucess() {
            ...
            var userCaputerd = userArgumentCaptor.getValue();


            assertEquals(input.username(), userCaputerd.getUsername());
            assertEquals(input.email(), userCaputerd.getEmail());
            assertEquals(input.password(), userCaputerd.getPassword());
    ...
    class listUsers {
        ...
        void shouldReturnAllUsersWithSucess() {
            ...
            var output = userService.listaUsers();
    ...
    @Nested
    class uodateUserById {

        @Test
        @DisplayName("Should update user by id when user exists and password is filled")
    ...
    @Test
    @DisplayName("Should not update user when user not")
    void shouldNotUpdateUserWhenUserNot() {
